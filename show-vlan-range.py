...
def escreverPlanilha(fpath, tabelaIpInterface, dicionarioVlan, listVlansMostrar, listInterfacesMostrar):
    ...
    for ip, dicionarioInterfaceVlan in tabelaIpInterface.items():
        ...
        for i in range(len(listVlansMostrar)):
            ws.write(linha+i+1, 0, listVlansMostrar[i], style0)
...
def main():
    ...
    #listVlansMostrar = [12, 32,	62,	66,	68,	71,	77,	79,	88,	93,	94,	99,	101, 102, 103, 105, 106, 107, 126, 130, 138, 139, 145, 146, 173, 174, 175, 180, 181,	191, 196, 199, 201, 210, 217, 219, 230, 259, 260, 263, 267, 269, 270, 271,	272, 273, 275, 276]
    fpathCSV = input('Caminho do arquivo csv: ')
